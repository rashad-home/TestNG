...
public class MainDashBoardTest_Chrome {
	...
	public static final Logger LOGGER = LogManager
			.getLogger(MainDashBoardTest_Chrome.class.getName());
	...
	public static String className = MainDashBoardTest_Chrome.class
			.getSimpleName();
	...
	@Test(dataProvider="getData",retryAnalyzer=ChromeRetryAnalyzer.class,testName = "Add Dashlet in Chrome",priority = 1)
	...
	//String firstName,String userName, String lastName,String email,String fullName,String screenShotName
		...
		if (method.getName().equals("addDashlet")) {
				result = new Object[][] {
							{"RSS Feed - Display the contents of an RSS feed given a URL configuration parameter.", "ChromeLoginTest15"} 
										};
					}
							return result;
