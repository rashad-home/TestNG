...
static ExtentReports extent;
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Add Site Dashlet in IE",priority = 1)
...
//	        dashboard.deleteSite();
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "DeleteSite in IE",priority = 2)
	...
	for (int i = 0; i < myList.size(); i++) {
		...
		test.log(LogStatus.INFO, "Test case e_deleteSite executed");
			...
			if (method.getName().equals("addSiteDashlet")) {
					result = new Object[][] {
								{"IETest","ietest","RSS Feed - Display the contents of an RSS feed given a URL configuration parameter.", "IELoginTest20"} 
											};
						}else if (method.getName().equals("DeleteSite")) {
							result = new Object[][] { 
									{ "IETest", "ietest", "IELoginTest21"}
												};
						}
								return result;
