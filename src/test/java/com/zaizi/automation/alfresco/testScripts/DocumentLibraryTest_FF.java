...
public class DocumentLibraryTest_FF {
	...
	@Test(dataProvider="getData",retryAnalyzer=FFRetryAnalyzer.class,testName = "Upload Document in FF",priority = 3)
	...
	/*@Parameters({"siteFF", "documentNameFF","screenShotNameFF" })*/
	@Test(dataProvider="getData",retryAnalyzer=FFRetryAnalyzer.class,testName = "Upload Document in FF",priority = 4)
	...
	@Test(dataProvider="getData",retryAnalyzer=FFRetryAnalyzer.class,testName = "Upload Document in FF",priority = 5)
	...
	/*@Parameters({"siteFF", "documentNameFF","screenShotNameFF" })*/
	@Test(dataProvider="getData",retryAnalyzer=FFRetryAnalyzer.class,testName = "Delete Document in FF",priority = 6)
	...
	@Test(dataProvider="getData",retryAnalyzer=FFRetryAnalyzer.class,testName = "Create site in FF",priority = 7)
	...
	if (method.getName().equals("createUser")) {
	        result = new Object[][] {
	                    { "privateuser", "privateuser" , "privateuser@gmail.com","privateuser" ,"1qaz@WSX" , "privateuser privateuser", "FFDocumentLibTest"} 
	                                };
	}else if (method.getName().equals("createSite")) {
	        result = new Object[][] { 
	                    { "UKDOCFF", true, "UKDOCFFUrl","COULD NOT CREATE SITE SINCE THE URL IS ALREADY USED","Administrator","FFDocumentLibTest"}
	                                };
	}else if (method.getName().equals("uploadDocument")) {
	        result = new Object[][] { 
	                    { "UKDOCFF", "FileB.rtf","FFDocumentLibTest"}
	                                };
	    ...
	    result = new Object[][] { 
	            { "UKDOCFF", "FileB.rtf", "privateuser","privateuser privateuser","Site Contributor","FFDocumentLibTest"}
	                        };
	    ...
	    result = new Object[][] { 
	            { "UKDOCFF", "UKDOCFFUrl", "FFDocumentLibTest"}
	                        };
	}
	                    return result;
	    }
