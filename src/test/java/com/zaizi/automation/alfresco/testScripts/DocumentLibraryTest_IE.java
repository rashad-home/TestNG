...
public class DocumentLibraryTest_IE {
	...
	public static final Logger LOGGER = LogManager
			.getLogger(DocumentLibraryTest_IE.class.getName());
	...
	public static String className = DocumentLibraryTest_IE.class
			.getSimpleName();
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Upload Document in IE",priority = 3)
...

	{
		...
		extent.flush();
                ...
                TakeScreenShot ts=new TakeScreenShot();
        	   	...
        	   	test.log(LogStatus.INFO, "Site is not visible in search : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"15"+".png"));
        	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
                extent.flush(); 
	...
	/*@Parameters({"siteIE", "documentNameIE","screenShotNameIE" })*/
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Upload Document in IE",priority = 4)
       ...
       test.log(LogStatus.INFO, "Verify whether document " +documentName+" uploaded or not");     
		...
		//Expected Result
        	...
        	TakeScreenShot ts=new TakeScreenShot();
    	   	...
    	   	test.log(LogStatus.PASS, "User has uploaded document : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"16"+".png"));
    	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
            extent.flush(); 
		}
		else
		{
        	...
        	TakeScreenShot ts=new TakeScreenShot();
    	   	...
    	   	test.log(LogStatus.FAIL, "User has NOT uploaded document : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"17"+".png"));
    	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
            extent.flush(); 
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Upload Document in IE",priority = 5)
	...
	{    
        ...
        TakeScreenShot ts=new TakeScreenShot();
  	   	...
  	   	test.log(LogStatus.INFO, "Give manage permission for document level : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"18"+".png"));
  	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
        extent.flush(); 
        ...
        LOGGER.info("Navigate to the " +siteName);
 		...
 		Thread.sleep(3000); 
 	   	...
 	   	test.log(LogStatus.INFO, "Search the site : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"19"+".png"));
 	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
        extent.flush();		 
         ...
         if (Element.isElementPresent(driver, By.xpath("//div[text()='"+fullName+"']/ancestor::td/following-sibling::td[1]//button[text()='"+roleName+"']")))
         {
         	LOGGER.info(TestCaseProperties.TEXT_TEST_PASS,"Successfully user "+fullName+" added to role "+roleName+" in manage Permission");
      		test.log(LogStatus.PASS, "Successfully user "+fullName+" added to role "+roleName+" in manage Permission");
     	   	...
     	   	test.log(LogStatus.PASS, "Mange permisison was successfull : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"20"+".png"));
     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
            extent.flush(); 
         }
         else
         {
         	LOGGER.error(TestCaseProperties.TEXT_TEST_FAIL,"User "+fullName+" IS NOT added to role "+roleName+" in manage Permission");
      		test.log(LogStatus.FAIL, "User "+fullName+" IS NOT added to role "+roleName+" in manage Permission");
     	   	...
     	   	test.log(LogStatus.FAIL, "Mange permisison was NOT successfull : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"21"+".png"));
     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
            extent.flush(); 
         }
	...
	/*@Parameters({"siteIE", "documentNameIE","screenShotNameIE" })*/
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Delete Document in IE",priority = 6)
...

	{
		...
		Thread.sleep(3000);
			...
			TakeScreenShot ts=new TakeScreenShot();
		   	...
		   	test.log(LogStatus.INFO, "Delete Document : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"22"+".png"));
		   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	    extent.flush(); 
		...
		//--- Folder Validation	
	    		...
	    		Thread.sleep(2000);
	     	   	...
	     	   	test.log(LogStatus.INFO, "Search the document : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"23"+".png"));
	     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	            extent.flush(); 
	    		 ...
	    		 if(Element.isElementPresent(driver, By.xpath("//tbody[@class='yui-dt-message']//tr//td//div[text()='No items exist']")))
	      		{
	      			...
	      			test.log(LogStatus.PASS, documentName+" Document IS DELETED SUCCESSFULLY");
	  	     	   	...
	  	     	   	test.log(LogStatus.PASS, "Document is deleted : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"24"+".png"));
	  	     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	  	            extent.flush(); 
	      		}
	      		else if(Element.isElementPresent(driver,By.xpath("//a[text()='"+documentName+"']")))
	      		{
	      			...
	      			test.log(LogStatus.PASS, documentName+" Document IS DELETED SUCCESSFULLY");
	      	 	   	...
	      	 	   	test.log(LogStatus.PASS, "Document is Deleted : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"A24"+".png"));
	      	 	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	      	        extent.flush(); 
	      		}
	    		else{
	    	...
	    	for (int i = 0; i < myList.size(); i++) {
	    		...
	    		{	
	    			...
	    			test.log(LogStatus.FAIL, documentName+" Document IS NOT DELETED");
		     	   	...
		     	   	test.log(LogStatus.FAIL, "Document is not deleted : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"25"+".png"));
		     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
		            extent.flush(); 
	    		}
	    		else
	    		{
	    			...
	    			test.log(LogStatus.PASS, documentName+"Document IS DELETED SUCCESSFULLY");
		     	   	...
		     	   	test.log(LogStatus.PASS, "Document is deleted : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"26"+".png"));
		     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
		            extent.flush(); 
	    		}
	    		}
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Create site in IE",priority = 7)
...

	{
		...
		TakeScreenShot ts=new TakeScreenShot();
		   	...
		   	test.log(LogStatus.INFO, "Search Site : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"27"+".png"));
		   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	    extent.flush(); 
		...
		if(Element.isElementPresent(driver, By.xpath("//tbody[@class='yui-dt-message']//tr//td//div[text()='No items exist']")))
		{
			...
			test.log(LogStatus.PASS, siteName+" SITE IS DELETED SUCCESSFULLY");
	 	   	...
	 	   	test.log(LogStatus.PASS, "Site is Deleted : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"28"+".png"));
	 	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	        extent.flush(); 
		}
		else if(Element.isElementPresent(driver,By.xpath("//div[text()='"+siteId+"']")))
		{
			...
			test.log(LogStatus.PASS, siteName+" SITE IS DELETED SUCCESSFULLY");
	 	   	...
	 	   	test.log(LogStatus.PASS, "Site is Deleted : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"A28"+".png"));
	 	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	        extent.flush(); 
		}
		else{
	...
	for (int i = 0; i < myList.size(); i++) {
		...
		{	
			...
			test.log(LogStatus.FAIL, siteName+" SITE IS NOT DELETED");
	 	   	...
	 	   	test.log(LogStatus.FAIL, "Site is not deleted : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"29"+".png"));
	 	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	        extent.flush(); 
		}
		else
		{
			...
			ts.takeScreenShot(driver,className, screenShotName+"30");
	 	   	test.log(LogStatus.PASS, "Site is not deleted : " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"30"+".png"));
	 	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	        extent.flush(); 
		}
		}
	...
	if (method.getName().equals("createUser")) {
	        result = new Object[][] {
	                    { "privateuser", "privateuser" , "privateuser@gmail.com","privateuser" ,"1qaz@WSX" , "privateuser privateuser", "IEDocumentLibTest"} 
	                                };
	}else if (method.getName().equals("createSite")) {
	        result = new Object[][] { 
	                    { "UKDOCIE", true, "UKDOCIEUrl","COULD NOT CREATE SITE SINCE THE URL IS ALREADY USED","Administrator","IEDocumentLibTest"}
	                                };
	}else if (method.getName().equals("uploadDocument")) {
	        result = new Object[][] { 
	                    { "UKDOCIE", "FileC.rtf","IEDocumentLibTest"}
	                                };
	    ...
	    result = new Object[][] { 
	            { "UKDOCIE", "FileC.rtf", "privateuser","privateuser privateuser","Site Contributor","IEDocumentLibTest"}
	                        };
	    ...
	    result = new Object[][] { 
	            { "UKDOCIE", "UKDOCIEUrl", "IEDocumentLibTest"}
	                        };
	}
	                    return result;
	    }
