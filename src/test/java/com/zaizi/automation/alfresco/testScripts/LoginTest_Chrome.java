...
public class LoginTest_Chrome  {
	...
	public static final Logger LOGGER = LogManager
			.getLogger(LoginTest_Chrome.class.getName());
...
static ExtentReports extent;
	...
	public static String className = LoginTest_Chrome.class
			.getSimpleName();
...
/*	@Parameters({"userNameChrome","PasswordChrome","fullNameChrome","screenShotNameChrome" })*/
	@Test(dataProvider="getData",retryAnalyzer=ChromeRetryAnalyzer.class,testName = "Login & Logout in Chrome",priority = 2)
    ...
    if (method.getName().equals("createUser")) {
            result = new Object[][] {
                        { "test", "test" , "test@gmail.com","testChrome" ,"user@123" , "test test", "ChromeLoginTest"} 
                                    };
    }else if (method.getName().equals("loginANDlogout")) {
            result = new Object[][] { 
                        { "testChrome", "user@123", "test test","ChromeLoginTest"}
                                    };
    }else if (method.getName().equals("deleteUser")) {
            result = new Object[][] { 
                        { "testChrome", "test", "test","ChromeLoginTest"}
                                    };
    }
                        return result;
        }
