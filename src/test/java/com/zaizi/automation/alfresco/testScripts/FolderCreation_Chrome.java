...
public class FolderCreation_Chrome {
	...
	@Test(dataProvider="getData",retryAnalyzer=ChromeRetryAnalyzer.class,testName = "Folder creation in Chrome",priority = 3)
...
/*@Parameters({"siteChrome", "folderNameChrome","folderTitleChrome","screenShotNameChrome" })*/
@Test(dataProvider="getData",retryAnalyzer=ChromeRetryAnalyzer.class,testName = "Delete Folder in Chrome",priority = 4)
...
@Test(dataProvider="getData",retryAnalyzer=ChromeRetryAnalyzer.class,testName = "Delete site in Chrome",priority = 5)
...
if (method.getName().equals("createUser")) {
        result = new Object[][] {
                    { "privateuser", "privateuser" , "privateuser@gmail.com","privateuser" ,"1qaz@WSX" , "privateuser privateuser", "ChromeFolderCreation"} 
                                };
}else if (method.getName().equals("createSite")) {
        result = new Object[][] { 
                    { "UKFOLDERCHROME", false, "ukfolderchromeURL","COULD NOT CREATE SITE SINCE THE URL IS ALREADY USED","Administrator","ChromeFolderCreation"}
                                };
}else if (method.getName().equals("folderCreation")) {
        result = new Object[][] { 
                    { "UKFOLDERCHROME", "FolderChrome", "FolderChromeTitle","ChromeFolderCreation"}
                                };
    ...
    result = new Object[][] { 
            { "UKFOLDERCHROME", "ukfolderchromeURL", "ChromeFolderCreation"}
                        };
}
                    return result;
    }
