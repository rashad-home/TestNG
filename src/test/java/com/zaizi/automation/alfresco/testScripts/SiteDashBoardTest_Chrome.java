...
public class SiteDashBoardTest_Chrome {
	...
	public static final Logger LOGGER = LogManager
			.getLogger(SiteDashBoardTest_Chrome.class.getName());
...
static ExtentReports extent;
	...
	public static String className = SiteDashBoardTest_Chrome.class
			.getSimpleName();
	...
	@Test(dataProvider="getData",retryAnalyzer=ChromeRetryAnalyzer.class,testName = "Add Site Dashlet in Chrome",priority = 1)
...
//			
//			
//			Link siteDashlet = new Link(driver, By.xpath("//a[text()='ChromeTest']//ancestor::h1[@id='HEADER_TITLE']"));
//			siteDashlet.click();
	       ...
	       /* Division rssFeedBlog = new Division(
	        ...
	        if(Element.isElementPresent(driver, By.xpath("//div[@id='page_x002e_component-1-2_x002e_site_x007e_"+siteURL+"_x007e_dashboard_x0023_default-title']"))){
				...
				TakeScreenShot ts=new TakeScreenShot();
	     	   	...
	     	   	test.log(LogStatus.PASS, "Snapshot below: " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"105"+".png"));
	        ...
	        else
	        {
				...
				TakeScreenShot ts=new TakeScreenShot();
	     	   	...
	     	   	test.log(LogStatus.FAIL, "Snapshot below: " +test.addScreenCapture(TestCaseProperties.SCREENSHOTPATH+className+"/"+screenShotName+"105"+".png"));
	     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	            extent.flush();  
...
//	        dashboard.deleteSite();
	...
	@Test(dataProvider="getData",retryAnalyzer=ChromeRetryAnalyzer.class,testName = "DeleteSite in Chrome",priority = 2)
	...
	for (int i = 0; i < myList.size(); i++) {
		...
		test.log(LogStatus.INFO, "Test case e_deleteSite executed");
			...
			if (method.getName().equals("addSiteDashlet")) {
					result = new Object[][] {
								{"ChromeTest","chrometest","RSS Feed - Display the contents of an RSS feed given a URL configuration parameter.", "ChromeLoginTest20"} 
											};
						}else if (method.getName().equals("DeleteSite")) {
							result = new Object[][] { 
									{ "ChromeTest", "chrometest", "ChromeLoginTest21"}
												};
						}
								return result;
