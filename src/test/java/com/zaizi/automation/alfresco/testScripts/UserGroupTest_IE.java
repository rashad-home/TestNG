...
public class UserGroupTest_IE {
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Create Group in IE",priority = 1)
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Edit Group in IE",priority = 2)
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Remove Group in IE",priority = 3)
    ...
    if (method.getName().equals("createGroup")) {
            result = new Object[][] {
                        { "GroupIE", "GroupIEID" , "IEGroupUserTest"} 
                                    };
    }else if (method.getName().equals("EditGroup")) {
            result = new Object[][] { 
                        { "GroupIE", "newGroupIE","IEGroupUserTest"}
                                    };
    }else if (method.getName().equals("removeGroup")) {
            result = new Object[][] { 
                        { "newGroupIE","IEGroupUserTest"}
                                    };
    }
                        return result;
        }
