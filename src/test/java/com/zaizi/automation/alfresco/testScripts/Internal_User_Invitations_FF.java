...
static ExtentReports extent;
			...
			Boolean isPrivate,String screenShotName) throws InterruptedException, IOException
    {
        ...
        {	
	     ...
	     test.log(LogStatus.INFO,"Enter "+siteId+" in \"site URL Field\" ");	
             ...
             TakeScreenShot ts=new TakeScreenShot();
	     	   	ts.takeScreenShotFF(driver,className, screenShotName+"170");
	     	   	test.log(LogStatus.PASS, "Snapshot below: " +test.addScreenCapture("./"+className+"/"+screenShotName+"170"+".png"));
	     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
	            extent.flush();  
			...
			if(Element.isElementPresent(driver,By.xpath("//Span[text()='No sites found']"))) 
			{
				...
				test.log(LogStatus.FAIL,"<font color=blue>"+siteName+ " SITE IS NOT VISIBLE TO "+siteCreatorName+"<font>");
				 ...
				 TakeScreenShot ts1=new TakeScreenShot();
		     	   	ts1.takeScreenShotFF(driver,className, screenShotName+"171");
			...
			{	
				...
				test.log(LogStatus.INFO,"<font color=blue>"+siteName+ " SITE IS VISIBLE TO "+siteCreatorName+"<font>");
				 ...
				 TakeScreenShot ts2=new TakeScreenShot();
		     	   	ts2.takeScreenShotFF(driver,className, screenShotName+"172");
		     	   	test.log(LogStatus.PASS, "Snapshot below: " +test.addScreenCapture("./"+className+"/"+screenShotName+"172"+".png"));
		     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
		            extent.flush();  
                ...
                if(Element.isElementPresent(driver,By.xpath("//Span[text()='No sites found']"))) 
                {
                    ...
                    TakeScreenShot ts3=new TakeScreenShot();
    	     	   	ts3.takeScreenShotFF(driver,className, screenShotName+"173");
                ...
                else 
                {
                    ...
                    if (Element.isTextPresentInList(driver.findElements(By.xpath("//tbody//tr//td//div//h3//a[contains(., '" + siteName+ "')]")), siteName)) {
                        ...
                        TakeScreenShot ts4=new TakeScreenShot();
        	     	   	ts4.takeScreenShotFF(driver,className, screenShotName+"174");
        	     	   	test.log(LogStatus.FAIL, "Snapshot below: " +test.addScreenCapture("./"+className+"/"+screenShotName+"174"+".png"));
        	     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
        	            extent.flush();  
                        ...
                        TakeScreenShot ts5=new TakeScreenShot();
        	     	   	ts5.takeScreenShotFF(driver,className, screenShotName+"175");
        	     	   	test.log(LogStatus.PASS, "Snapshot below: " +test.addScreenCapture("./"+className+"/"+screenShotName+"175"+".png"));
        	     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
        	            extent.flush();  
    	    ...
    	    else 
    	    {
	        	...
	        	test.log(LogStatus.FAIL, "Current Test Results : " +"<font color=red>" +siteErrorNotification+"<font>");        	
	        	 ...
	        	 TakeScreenShot ts=new TakeScreenShot();
		     	   	...
		     	   	test.log(LogStatus.FAIL, "Snapshot below: " +test.addScreenCapture("./"+className+"/"+screenShotName+"178"+".png"));
		     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
		            extent.flush();  
    	    }
		}
		...
		else 
		{
			if (Element.isTextPresentInListForSite(driver.findElements(By.xpath("//tbody//tr//td//div//h3//a[contains(., '" + siteName+ "')]")), siteName)) {
                            ...
                            TakeScreenShot ts=new TakeScreenShot();
            	     	   	...
            	     	   	test.log(LogStatus.FAIL, "Snapshot below: " +test.addScreenCapture("./"+className+"/"+screenShotName+"181"+".png"));
            	     	   	LOGGER.info("Screenshot Taken Successfully!!!!");  
            	            extent.flush();  
			...
			String roleName,String expectedResult,String screenShotName) throws InterruptedException, IOException
    {
		...
		if (siteDashboardPage.checkInternalUserInvite(siteName, className,
			...
			//	Element.takeScreenShotFF(driver, className, screenShotName
				//		+ "spvalid1");
			} 
...

	{
		...
		if(adminConsolePage2.checkUserPresence(userName))
			...
			else
			{
		        ...
		        TakeScreenShot ts=new TakeScreenShot();
	     	   	ts.takeScreenShotFF(driver,className, screenShotName+"192");
