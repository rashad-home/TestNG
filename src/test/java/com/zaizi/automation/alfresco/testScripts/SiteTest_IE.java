...
public class SiteTest_IE {
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Create user in IE",priority = 2)
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Create site in IE",priority = 1)
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Edit site in IE",priority = 3)
	...
	@Test(dataProvider="getData",retryAnalyzer=IERetryAnalyzer.class,testName = "Delete site in IE",priority = 4)
    ...
    if (method.getName().equals("createUser")) {
            result = new Object[][] {
                        { "privateuser", "privateuser" , "privateuser@gmail.com","privateuser" ,"1qaz@WSX" , "privateuser privateuser", "IESiteTest"} 
                                    };
    }else if (method.getName().equals("createSite")) {
            result = new Object[][] { 
                        { "UKIE", false, "ukIEURL","COULD NOT CREATE SITE SINCE THE URL IS ALREADY USED","Administrator","IESiteTest"}
                                    };
    }else if (method.getName().equals("editSite")) {
            result = new Object[][] { 
                        { "UKIE", "UKIE2", "IESiteTest"}
                                    };
    }else if (method.getName().equals("deleteSite")) {
        result = new Object[][] { 
                { "UKIE2", "ukIEURL", "IESiteTest"}
                            };
    }
                        return result;
        }
